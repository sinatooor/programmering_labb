...
first_answer = typed_input.check_ga(f"Is your first sum arthmetic or geometric? {colorama.Fore.GREEN}")#denna "fungerar inte" går vidare även om man skriver annat än a och b
...
second_answer = typed_input.check_ga(f"Is your second sum arthmetic or geometric? {colorama.Fore.GREEN}") #denna "fungerar inte" går vidare även om man skriver annat än a och b
