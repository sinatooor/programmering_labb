...
first_answer = typed_input.check_ga(f"Is your first sum arthmetic or geometric?{colorama.Fore.GREEN}")
print(end="")
if first_answer == "a":
...
second_answer = typed_input.check_ga(f"Is your second sum arthmetic or geometric?{colorama.Fore.GREEN}")
print(end="")
